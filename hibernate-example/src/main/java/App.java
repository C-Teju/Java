...
import org.kodnest.hibernate_example.Bike;
import org.kodnest.hibernate_example.Student;

public class App {

	public static void main(String[] args) {
		Student s1=new Student(1, "Breen", 85);
    	Student s2=new Student(1, "Morena", 90);
    	Student s3=new Student(1, "Aisling", 85);
